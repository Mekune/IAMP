...
Public Class GestionBDD
    ...
    Public Shared Serveur As String = "localhost"
    Public Shared BDD As String = "ppe_marchand_diaz2"
    Public Shared Login As String = "root"
    Public Shared Mdp As String = "root"
    Public Shared Machaine As String = "Data source=localhost;Initial Catalog=ppe_marchand_diaz2;User ID=root;Password=root"
    Public Shared CptVue As Integer = 0
    Public Shared Sub SeConnecter(Serveur As String, BDD As String, Login As String, Mdp As String)

        Machaine = "Data source=" + Serveur + ";Initial Catalog=" + BDD + ";User ID=" + Login + ";Password=" + Mdp + ""
        MaConnexion.ConnectionString = Machaine
        MaConnexion.Open()
        MonJeuDeDonnees = New Data.DataSet("ppe_marchand_diaz2")
